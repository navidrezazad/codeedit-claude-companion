...
private extension GeneralSettingsView {
    ...
    var remoteAccessPasscodeField: some View {
        LabeledContent("iPhone Remote Passcode") {
            VStack(alignment: .leading, spacing: 6) {
                HStack {
                    TextField("Passcode", text: $remoteAccessPasscode)
                ...
                if !remoteAccessStatus.isEmpty {
                    Text(remoteAccessStatus)
                        .font(.caption)
    ...
    var updateChecker: some View {
        Section {
            LabeledContent {
                ...
                .disabled(AppRuntime.isCodeEditV2Fork)
            } label: {
